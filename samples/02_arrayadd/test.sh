...
iverilog -g2005 -s tb tb/tb.v src/top.v injected/top__injected.v \
  ../../verilog/ff/verinject_ff_injector.v ../../verilog/memory_fifo/verinject_mem1_injector.v ../../verilog/gen/verinject_serial_tester.v ../../verilog/monitor/verinject_sim_monitor.v \
  -I mem -o runner.vvp &&
